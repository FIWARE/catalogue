...
NAME="data-publication/business-api/chargin-backend" 
SOURCE="telefonicaiot/chargin-backend"
DOCKER_TARGET="fiware/chargin-backend"
QUAY_TARGET="quay.io/fiware/chargin-backend"
