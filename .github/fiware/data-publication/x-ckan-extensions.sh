...
NAME="data-publication/ckan-extensions/ckan-extensions" 
SOURCE="telefonicaiot/ckan-extensions"
DOCKER_TARGET="fiware/ckan-extensions"
QUAY_TARGET="quay.io/fiware/ckan-extensions"
