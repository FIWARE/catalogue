...
NAME="data-publication/business-api/ordering-management" 
SOURCE="telefonicaiot/ordering-management"
DOCKER_TARGET="fiware/ordering-management"
QUAY_TARGET="quay.io/fiware/ordering-management"
