...
NAME="data-publication/ckan-extensions/wirecloud-dashboards" 
SOURCE="telefonicaiot/wirecloud-dashboards"
DOCKER_TARGET="fiware/wirecloud-dashboards"
QUAY_TARGET="quay.io/fiware/wirecloud-dashboards"
