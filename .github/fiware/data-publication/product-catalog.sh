...
NAME="data-publication/business-api/product-catalog" 
SOURCE="telefonicaiot/product-catalog"
DOCKER_TARGET="fiware/product-catalog"
QUAY_TARGET="quay.io/fiware/product-catalog"
