...
NAME="data-publication/business-api/customer-management" 
SOURCE="telefonicaiot/customer-management"
DOCKER_TARGET="fiware/customer-management"
QUAY_TARGET="quay.io/fiware/customer-management"
